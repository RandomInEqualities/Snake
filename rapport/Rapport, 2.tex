...
\begin{figure}[b]
	\centering
	\graphicspath{ {pics/} }
	\subfloat[Snake Menu]{\label{fig:menu}\includegraphics[width=0.3\textwidth]{snake.png}}
	\hspace{0.1\textwidth}
	\subfloat[Snake Game]{\label{fig:game}\includegraphics[width=0.31\textwidth]{snake2.png}}
\end{figure}
